...
export let BootstrapMultiselect = (_dec = customElement('bootstrap-multiselect'), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = (_class2 = class BootstrapMultiselect {
    constructor() {
